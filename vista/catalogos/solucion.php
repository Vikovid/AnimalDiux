<?php
   ...
   if ($descripcion!="") $solucion = buscaSoluciones($descripcion);
   else                  $solucion = find_all("soluciones");
?>
...
<body onload="focoNombre();">
   <form name="form1" method="post" action="solucion.php"><br>
            ...
            <div class="panel-heading clearfix">
               <div class="pull-right">
                  <div class="form-group">
                     ...
                     <a href="add_solucion.php" class="btn btn-primary">Agregar Medicamento Inyectable</a>
                  </div>
               </div>   
            </div>
               ...
               <table class="table table-bordered">
                  <thead>
                     <tr>
                        ...
                        <th class="text-center" style="width: 38%;">Nombre</th>
                        <th class="text-center" style="width: 20%;">Cantidad</th>
                        <th class="text-center" style="width: 20%;">Fecha de caducidad</th>
                  ...
                  <tbody>
                     <?php foreach ($solucion as $solucion):?>
                        <tr>
                           ...
                           <td> <?php echo remove_junk($solucion['nombre']); ?></td>
                           <td class="text-center"> <?php echo remove_junk($solucion['cantidad']); ?></td>
                           <td class="text-center"> <?php echo date('d-m-Y',strtotime($solucion['fechaCaducidad'])) ?> </td>
