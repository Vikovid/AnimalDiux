...
<body onload="responsable();">
   ...
   <?php
      if($idSucursal != ""){
         if ($responsable != "") $historico = histConsUsuSuc($responsable,$idSucursal);
         else $historico = histConsSuc($idSucursal);
      }else{
         if ($responsable != "") $historico = histConsUsu($responsable);
         else $historico = histConsulta();
      }
   ?>
            ...
            <table class="table table-bordered">
               ...
               <tbody>
                  <?php foreach ($historico as $historico):?>
                     <tr>
                        <td class="text-center"><?php echo remove_junk($historico['username']); ?></td>
